...
struct RelayFlavourTests {
    ...
    func readsTheBundleIdentifier() {
        #expect(
            RelayFlavour.resolve(environment: nil, bundleIdentifier: "com.maketryuk.relay.dev") == .development
        )
        #expect(RelayFlavour.resolve(environment: nil, bundleIdentifier: "com.maketryuk.relay") == .release)
    }
